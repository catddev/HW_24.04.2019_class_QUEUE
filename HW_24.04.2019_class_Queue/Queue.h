...
//Реализуйте класс очередь(Queue), у которого есть методы
//T& back() – возвращает значение последнего элемента;
//T& front() - возвращает значение первого элемента;
//void push(T el) – добавляет элементы с конца
//void pop() – удаляет элементы с начала
//int size()
//bool empty()
//Напишите реализацию меню для тестирования методов очереди
